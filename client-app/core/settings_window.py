...
class TkSettingsWindow:
    ...
    def __init__(self, on_save_callback: Optional[Callable[[], None]] = None):
        ...
        # Form variables
        self.ws_quick_var: Optional[tk.StringVar] = None
        self.server_url_var: Optional[tk.StringVar] = None
        self.api_key_var: Optional[tk.StringVar] = None
        self.client_name_var: Optional[tk.StringVar] = None

        # Live status labels
        self.lbl_relay_status: Optional[tk.Label] = None
        self.lbl_group: Optional[tk.Label] = None
        self.lbl_printer: Optional[tk.Label] = None
        self.lbl_test_result: Optional[tk.Label] = None
        self.btn_test: Optional[tk.Button] = None
        self.btn_show_key: Optional[tk.Button] = None
        self.entry_api_key: Optional[tk.Entry] = None

    def init_ui(self, root: tk.Tk):
